...
public class Auction extends AuctionBase
{
	...
	private transient String auctionTimer;
	...
	public void setAuctionTimer(String auctionTimer) 
	{
	...
	public void decrementTimer()
	{
		...
		Long current = auctionEndDate.getTime() - currentDate.getTime();

		if(current > 0)
		{
			Long minutes = ((current / (1000*60)) % 60);
			...
			auctionTimer =  minString + ":" + secString;
		}
		else
		{
			auctionTimer =  "00:00";
